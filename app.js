(() => {
  ...
  function normalizeScenario(scenario, index = 0) {
    ...
    normalized.scenario.recommendedSkills = array(normalized.scenario.recommendedSkills);
    normalized.scenario.secondarySkills = array(normalized.scenario.secondarySkills);
